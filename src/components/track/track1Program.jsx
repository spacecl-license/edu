...
export default function Track1Program() {
  return (
    <Wrapper>
      <Group1>
        <div>
          ...
          <ProgramText>
            ⦁ IT 프로그래밍과 일본어의 다중 역량이 요구되는 교육특성에 맞는
            특화과정으로 편성
            <br />
            ⦁ ICT 기술 기반의 다양한 산업현장에서 활용되는 소프트웨어 통합
            확산기술 접목
            <br />
            ⦁ 높은 수준의 WEB 개발에 특화된 개발환경 적용기술 학습
            <br />
            ⦁ 일본 현지기업의 요구사항이 절대적으로 높은 일본어 활용능력
            반영(실무응용, 비즈니스 일어)
            <br />
            ⦁ 취업 및 비자발급에 필요한 JLPT N2 취득교과를 별도로 편성하여
            자격증 취득 지원
            <br />
            ⦁ 각 과정별 목표달성을 위한 최적화된 연수시간 설계
            <br />
            ⦁ IT/일본어 입문자, 비전공자를 위한 맞춤형 교재 선정
            <br />⦁ 채용 협약기업 15개사 이상 직접 취업연계
          </ProgramText>
        </div>
      </Group1>
      <Group2>
